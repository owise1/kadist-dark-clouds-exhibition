var _pl={db:"liblib",design:"liblib-exhib"};window.URL=window.URL||window.webkitURL;var LibLibExhibApp=angular.module("LibLibExhibApp",["CornerCouch","ngSanitize"]).config(["$compileProvider",function(n){var i=/^\s*(https?|blob):/;n.aHrefSanitizationWhitelist(i),n.imgSrcSanitizationWhitelist(i)}]);LibLibExhibApp.controller("ListingCtrl",["$scope","$http","cornercouch",function(n,i,e){function t(){n.db.newDoc().load(s).success(function(i){n.exhibitionDoc=r(i)}).error(function(){n.db.newDoc({_id:s}).save().success(t).error(function(n){console.log("error 2"),console.log(n)})})}function o(){n.db.query(c.design,"media",{reduce:!1,limit:10,include_docs:!0}).success(function(i){n.medias=i.rows.map(R.prop("doc")).map(r).sort(function(n,i){return parseInt(n.info.order,10)>parseInt(i.info.order,10)}),t()})}function r(n){return n._attachments&&angular.forEach(n._attachments,function(i,e){/^cover\./.test(e)?n.coverImg="/"+c.db+"/"+n._id+"/"+e:(n.media=i,n.media.url="/"+c.db+"/"+n._id+"/"+e)}),n}var c=window._pl;n.db=e().getDB(c.db),n.touch=Modernizr.touch,n.currentVid=!1,n.setCurrent=function(i){n.currentVid=i},n.urlify=function(n){return"http://"+window.location.host+n};var a=/dialog/.test(window.location.href);n.videosProtected=function(){return Modernizr.touch||a};var s="liblib-exhib-exhibition";n.upload=function(i){for(var e,t=[],r=0;e=i.files[r];r++)t.push(e);t.forEach(function(i){var e=n.db.newDoc({name:i.name,content_type:i.type});e.save().success(function(){e.attach(i,i.name,o)})})},n.del=function(i){n.db.newDoc(i).remove().success(o)},n.save=function(i){var e=i.file;if(e){delete i.file;var t=n.db.newDoc(i);t.save().success(function(){t.attach(e,"cover."+e.name.split(".").pop(),o)})}else n.db.newDoc(i).save().success(o)},o()}]).directive("fileread",[function(){return{scope:{fileread:"="},link:function(n,i){i.bind("change",function(i){n.$apply(function(){n.fileread=i.target.files[0]})})}}}]).filter("sanitize",["$sce",function(n){return function(i){return n.trustAsHtml(i)}}]);
